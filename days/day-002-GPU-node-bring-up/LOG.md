...
!
22:00 11 I am in the VM 

ozgur_graph_atlas_com@instance-20251118-160537:~$
ozgur_graph_atlas_com@instance-20251118-160537:~$ cat /etc/os-release
...
system_info.txt, nvidia_smi_initial.txt
...
Create a tiny CUDA test (or use the sample that ships with nvidia-cuda-toolkit):
...
Create a simple HF vs vLLM sanity script (just HF today if vLLM install is slow, but scaffold vLLM path):
